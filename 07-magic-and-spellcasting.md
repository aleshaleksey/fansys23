...
4. [Spells, Limitations and Alignment](#spells-limitations-and-alignment)
...
A common limitation, mainly of elemental spells, is that a spell does not function on entities and in locales with a given ["alignment"](00-overview.md#alignment). Thus a spell that creates undead or summons fiends might not function in areas with a "divine" alignment, while an elemental "wind"/"air" spell might not work in a locale aligned to "earth" (e.g. ["Wind Step"](08-spell-list.md#wind-step)).
