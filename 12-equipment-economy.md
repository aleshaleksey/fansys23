...
| Falchion        | 3           | 125       | 40                  | 6             | yes       | yes        | yes      |
...
|Holy-water (1lb flask)        |Special  |-                 |1 day        |16 |very rare|very rare |no       |
...
**Quicksilver**: This presumes a special formulation of quicksilver that adheres especially well to metals. Applying quicksilver to an item made of bronze, silver, gold or mithral reduces its material level to 1, adds 10 to its material rank (hence moving it down in the rankings), and removes any damage resistance/reduction it has. If the quicksilver is removed from the item, its material level, rank and damage resistance/reduction is restored. Removing the quicksilver requires intensive cleaning which takes 1 minute per lb of weight of the item. This process causes 1 point of damage to the item. This quicksilver is sold in either a sturdy flask, or in a delicate glass flask that is made for throwing (vs "touch" HiT) and breaks on impact. It can also be fired from a sling, in which case the range/increment is 360ft/40ft. 1 flask is enough to cover a medium sized entity and all of its equipment.

**Fey-silver**: This is a silvery, gleaming fluid, which probably has little relation to actual silver or quicksilver. It is produced via a complex and poorly understood alchemical procedure from the blood and essence of various fey. Applying fey-silver to any metal item reduces its material level to 1, adds 16 to its material rank (hence moving it down the rankings) and removes any damage resistance/reduction it may have. Applying fey-silver to articles of bronze or iron permanently ruins them. Otherwise, it can be removed by 10 minutes of intensive cleaning per lb of weight of the item. This process causes 4 points of damage to the item. The mechanics of application of fey-silver are otherwise the same as those of application of quicksilver. Fey that witness a character wielding or preparing fey-silver may develop a deep grudge against that character.

**Holy water**: This is water which has been imbued with a divine light and is anathema to profane beings. Holy water is not truly an alchemical product and can be prepared through a complex ritual that imbues water with a tiny amount of the power of creation. A profane being covered in holy water has disadvantage on attack rolls and saves for 1 minute or until it is dried (if sooner). In addition, it must succeed a CHA save (threshold=16) or become ["incapacitated"](10-conditions-types.md#incapacitated) until the end of its next turn. Holy water is supplied either in a sturdy flask or a delicate glass flask that is made for throwing (vs "touch" HiT) and breaks on impact. It can also be fired from a sling, in which case the range/increment is 360ft/40ft. 1 flask is enough to cover a medium sized entity and all of its equipment or to cover four 5ft squares. Characters wielding holy water become a primary target for profane beings. To create holy water, one must use the "Cure", "Least Heal", or "Flare" spell. Alternatively one must use material from a divine being. Holy water cannot be prepared in batches.
