...
|||||
|[Blind-sight](../06-abilities.md#blind-sight-i-vi)|||(Range=5ft)|
...
|Ability (**Adult**)|Bonus|Damage|Other|
|-|-|-|-|
...
|||||
|[Blind-sight](../06-abilities.md#blind-sight-i-vi)|||(Range=10ft)|
...
|Ability (**Elder**)|Bonus|Damage|Other|
|-|-|-|-|
...
A mudwalker looks a lot like a mudcrawler but a lot larger, towering over 30ft tall. When a mudcrawler has matured sufficiently, one crawler will devour the rest and mature into a much larger and more dangerous monster. Mudwalkers are enormous monsters that seek out humanoid settlements so that it can use its populace as nourishment for its young, that they may grow and continue the cycle.
...
|Alternate Form|||As a main action, a werewolf can transform into a [wolf](beasts-and-plants.md#wolf), or back into its humanoid form. Any equipment, or possessions are not transformed. On nights within 2 nights of the full moon a lesser werewolf must success|
|||||
|Keen Senses|||A werewolf has advantages on observe rolls that rely on hearing or scent|
...
|Ability|Bonus|Damage|Other|
|-|-|-|-|
|Sc: Fire VIII|Thr=22||Favourite: "Forest of Flame", "Greater Cosmic Seal", "Meteoric Flight", "Flame Stride", "Balance of Elements"|
|Sc: Incantation V|Thr=23||Favourites: "Pact", "Isolate Essence", "Least Weather Control","Cure", "Trace Secret Path"|
|Sc: Air III|Thr=22||Favourites: "Lesser Veil", "Guidance of the Winds"|
|Sc: Global||||
|Aphonic spell||||
|Still Spell||||
...
|Ability|Bonus|Damage|Other|
|-|-|-|-|
|Sc: Fire VI|Thr=21||Favourite: "Forest of Flame", "Flame Stride", "Balance of Elements"|
|Sc: Incantation IV|Thr=19||Favourites: "Least Weather Control","Cure", "Trace Secret Path"|
|Sc: Air III|Thr=21||Favourites: "Lesser Veil", "Guidance of the Winds"|
|Sc: Global||||
|Aphonic spell||||
|Still Spell||||
|Elemental Affinity: Fire||||
...
|Ability|Bonus|Damage|Other|
|-|-|-|-|
|Sc: Water VII|Thr=24||Favourite: "Transform mortal, "inner voice", "lesser cosmic seal", "aqueous step", "false aura", "mirage", "scry", "winter's touch"|
|Sc: Air VII|Thr=24||Favourites: "Greater Weather control", "razor wind", "greater fade", "least storm", "see spell", slumber", "silence", "Trace Secret Path"|
|Sc: Global||||
|Aphonic spell||||
|Still Spell||||
...
|Draconic Spell|||A dragon may use 2 MP dice to cast a spell of 5 MP dice or less as a secondary action.|
|Alternate form|||The dragon has a humanoid, animal and true form. It may shift between them as a "main action". Each form is constant (always the same animal, always the same humanoid, always the same dragon)|
|Sc: Water V|Thr=21||Favourite: "lesser cosmic seal", "aqueous step", "false aura", "mirage", "scry", "winter's touch"|
|Sc: Air V|Thr=21||Favourites: "greater fade", "least storm", "see spell", slumber", "silence", "Trace Secret Path"|
|Sc: Global||||
|Aphonic spell||||
|Still Spell||||
|Elemental Affinity: Ice||||
...
|Ability|Bonus|Damage|Other|
|-|-|-|-|
|Sc: Earth VII|Thr=20||Favourites: "Portal", "Create Secret Path", "False Regrowth", "see spell", slumber", "silence", "Trace Secret Path", "Revenant", "Lesser Cosmic Seal", "Healing Seed", "Balance of Elements", "Animate Golem", "Enchanted Ground", "Guidance of the Earth", "Earth Ward", "Slumber", "Dusk", "Summon Gnome", "Gnomes' Mercy", "Shape Earth", "Sour"|
|Sc: Nature III|Thr=20||Favourites: "Growth", "Animate Plant", "Cure", "Harvest", "Call Ailment", "Ensnare", "
Least Heal"|
|Sc: Global||||
|Alert||||
|Foresight||||
